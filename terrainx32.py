...
def resize_image(input_path, output_path, new_width, new_height):
    if os.path.isfile(input_path):
        ...
        print(f"L'image redimensionnée a été enregistrée sous '{output_path}'.")
    else:
...
def process_images():
    ...
    terrain_input_path = "assets/texture/terrain32.png"
    ...
    image_dict = multiply_coordinates(image_dict, 2)

    # Appel de la fonction pour fusionner les images sur terrain.png
    merge_images(image_dict, terrain_output_path, 32, 32, terrain_output_path)

    # Redimensionner terrainMipMapLevel2.png en 128x272
    resize_image(terrain_output_path, "output/terrainMipMapLevel2.png", 256, 544)
    print("La création de l'image 'terrainMipMapLevel2.png' est terminée.")
    ...
    resize_image("output/terrainMipMapLevel3.png", "output/terrainMipMapLevel3.png", 128, 272)
...
# Créer l'app
TextureApp = tk.Tk()
TextureApp.title("Converter : Terrain (x32)")
IconPath = os.path.abspath("assets/iconterrain32.ico")
...
process_button = tk.Button(TextureApp, text="Convert Blocks (x32)", command=process_images)
