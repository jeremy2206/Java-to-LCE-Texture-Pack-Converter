...
def process_images():
    ...
    "input/items/broken_elytra.png": (80, 16),
    ...
    "input/items/light_gray_silver.png": (224, 176),
    ...
    "input/items/rabbit_hide.png": (80, 224),
...
IconPath = os.path.abspath("assets/iconitem16_1.ico")
