...
def process_images():
    ...
    "input/blocks/chiseled_sandstone.png": (80, 224),
    ...
    "input/blocks/dark_prismarine.png": (208, 336),
    ...
    "input/blocks/dirt_path_side.png": (144, 368),
    "input/blocks/dirt_path_top.png": (160, 368),
    "input/blocks/dirt_podzol_side.png": (144, 352),
    "input/blocks/dirt_podzol_top.png": (160, 352),
    "input/blocks/dispenser_front.png": (224, 32),
    ...
    "input/blocks/dropper_front.png": (176, 16),
    ...
    "input/blocks/grass_block_top.png": (0, 0),
    "input/blocks/grass_block_snow.png": (64, 64),
    ...
    "input/blocks/leaves_birch.png": (176, 352),
    ...
    "input/blocks/oak_leaves.png": (64, 48),
    ...
    "input/blocks/smooth_stone_slab_side.png": (80, 0),
    "input/blocks/smooth_stone.png": (96, 0),
    ...
    "input/blocks/stone_bricks.png": (96, 48),
...
IconPath = os.path.abspath("assets/iconterrain16.ico")
