...
convert_button = tk.Button(TextureApp, text="Convert Blocks", command=process_imagesterrain)
...
dropdown_menu = tk.OptionMenu(TextureApp, x_multiplierterrain, *optionsterrain)
